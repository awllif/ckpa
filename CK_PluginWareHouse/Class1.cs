...
namespace CK_PluginWareHouse
{
    ...
    PlugQueryFormAttribute("QueryWareHouse"),
    PlugWriterAttribute(""),
    ...
    [PlugNameAttribute("出库申请"),
    PlugQueryFormAttribute("QueryWareHouse"),
    PlugWriterAttribute(""),
    PlugQueryCmdAttribute("9882c7ec-3c32-4041-ad38-d66ffa1afdf0"),
    PlugActionAttribute("商品类别"),
    PlugDescriptionAttribute("采购入库管理采购单明细数据,到货后可以通过采购入库进库 ")]
    public partial class CKPlugWarehouseIn : PluginNode
    {
        public CKPlugWarehouseIn()
        {
        }
        public override void Initialization()
        {
